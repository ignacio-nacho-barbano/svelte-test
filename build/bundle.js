...
var app = (function () {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img$1 = element("img");
    			attr_dev(img$1, "class", "logotype svelte-17y346z");
    			if (!src_url_equal(img$1.src, img_src_value = img)) attr_dev(img$1, "src", img_src_value);
    			attr_dev(img$1, "alt", "dymium logotype");
    			add_location(img$1, file, 16, 4, 444);
    		},
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!img_transition) img_transition = create_bidirectional_transition(img$1, fade, { duration: 400, delay: 1000 }, true);
    		...
    		o: function outro(local) {
    			if (!img_transition) img_transition = create_bidirectional_transition(img$1, fade, { duration: 400, delay: 1000 }, false);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "alt", "Dymium contact mail");
    			attr_dev(a, "class", "dymium-button-link svelte-17y346z");
    			attr_dev(a, "href", "mailto:info@dymium.com");
    			add_location(a, file, 26, 6, 655);
    		},
    		m: function mount(target, anchor) {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!a_transition) a_transition = create_bidirectional_transition(a, fade, { delay: 2000, duration: 300 }, true);
    				a_transition.run(1);
    			});
    		...
    		o: function outro(local) {
    			if (!a_transition) a_transition = create_bidirectional_transition(a, fade, { delay: 2000, duration: 300 }, false);
    			a_transition.run(0);
    			current = false;
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	let div;
    	let current;
    	let if_block0 = /*circlesVisible*/ ctx[0] && create_if_block_1(ctx);
    	let if_block1 = /*circlesVisible*/ ctx[0] && create_if_block(ctx);

    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Dymium";
    			t1 = space();
    			video = element("video");
    			...
    			attr_dev(h1, "class", "svelte-17y346z");
    			add_location(h1, file, 9, 2, 217);
    			attr_dev(source, "autoplay", "");
    			attr_dev(source, "muted", "");
    			if (!src_url_equal(source.src, source_src_value = "./assets/dymium-animated-video.webm")) attr_dev(source, "src", source_src_value);
    			attr_dev(source, "type", "video/webm");
    			add_location(source, file, 11, 2, 278);
    			video.autoplay = true;
    			video.loop = true;
    			attr_dev(video, "id", "dymium-animated");
    			attr_dev(video, "class", "svelte-17y346z");
    			add_location(video, file, 10, 0, 233);
    			attr_dev(div, "class", "overlay-content svelte-17y346z");
    			add_location(div, file, 24, 2, 594);
    			attr_dev(main, "class", "svelte-17y346z");
    			add_location(main, file, 8, 0, 208);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (/*circlesVisible*/ ctx[0]) {
    				if (if_block0) {
    					if_block0.p(ctx, dirty);

    					if (dirty & /*circlesVisible*/ 1) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	setTimeout(
    		() => {
    			$$invalidate(0, circlesVisible = true);
    		},
    		4000
    	);
    	...
    	$$self.$capture_state = () => ({ logotype: img, fade, circlesVisible });

    	$$self.$inject_state = $$props => {
    		if ('circlesVisible' in $$props) $$invalidate(0, circlesVisible = $$props.circlesVisible);
    	};
